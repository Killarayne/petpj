...
def get_news_snippets():
    ...
    if html:
        ...
        all_news = soup.findAll('li', class_='content-list__item_post')
        for new in all_news:
            title = new.find('a', class_='post__title_link').text
            url = new.find('a', class_='post__title_link')['href']
            published = new.find('span', class_='post__time').text
